...
group::group(group_info &data):_geometry(nullptr), _polygon_flags(nullptr), _loaded(false), _name(std::string("")) {
...
group::group():_geometry(nullptr), _polygon_flags(nullptr), _loaded(false), _name(std::string("")) {
...
void group::setName(std::string s) {
